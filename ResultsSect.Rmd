...
# Pair-wise comparisons and correct results
  for(r in 1:nr){
    ...
    if (p.corr[r] > 0.05) {
      ...
      for(i in 1:dim(allcomb)[2]){
        pt[r,i] <- unlist(summary(lme(pasteregions ~ 1 + gc, random = ~ 1 | suc, data = data.lmer[data.lmer$rc == r & (data.lmer$gc == labels.g[allcomb[1,i]] | data.lmer$gc == labels.g[allcomb[2,i]]),]))[20])[10]
      }
    ...
    if (p.cov.corr[r] > 0.05) {
      ...
      for(i in 1:dim(allcomb)[2]){
        pt.cov[r,i] <- unlist(summary(lme(pasteregions ~ 1 + gc, random = ~ 1 | suc, data = data.lmer.cov[data.lmer.cov$rc == r & (data.lmer.cov$gc == labels.g[allcomb[1,i]] | data.lmer.cov$gc == labels.g[allcomb[2,i]]),]))[20])[10]
      }
...
# Model without covariates
  kable(rbind(c("region", "No cov", "With cov"), cbind(substring(names(data.hyp[,3:24]), 4), round(p.corr, 3), round(p.cov.corr, 3))))
...
# Pair-wise comparisons and correct results
  for(r in 1:nr){
    ...
    if (p.corr.th[r] > 0.05) {
      ...
      for(i in 1:dim(allcomb)[2]){
        pt.th[r,i] <- unlist(summary(lme(pasteregions ~ 1 + gc, random = ~ 1 | suc, data = data.lmer.th[data.lmer.th$rc == r & (data.lmer.th$gc == labels.g[allcomb[1,i]] | data.lmer.th$gc == labels.g[allcomb[2,i]]),]))[20])[10]
      }
    ...
    if (p.cov.corr.th[r] > 0.05) {
      ...
      for(i in 1:dim(allcomb)[2]){
        pt.cov.th[r,i] <- unlist(summary(lme(pasteregions ~ 1 + gc, random = ~ 1 | suc, data = data.lmer.th.cov[data.lmer.th.cov$rc == r & (data.lmer.th.cov$gc == labels.g[allcomb[1,i]] | data.lmer.th.cov$gc == labels.g[allcomb[2,i]]),]))[20])[10]
      }
...
# Model without covariates
  kable(rbind(c("region", "No cov", "With cov"), cbind(substring(names(data.hyp[,47:56]), 4), round(p.corr.th, 3), round(p.cov.corr.th, 3))))
...
# Pair-wise comparisons and correct results
  for(r in 1:nr){
    ...
    if (p.corr.sa[r] > 0.05) {
      ...
      for(i in 1:dim(allcomb)[2]){
        pt.sa[r,i] <- unlist(summary(lme(pasteregions ~ 1 + gc, random = ~ 1 | suc, data = data.lmer.sa[data.lmer.sa$rc == r & (data.lmer.sa$gc == labels.g[allcomb[1,i]] | data.lmer.sa$gc == labels.g[allcomb[2,i]]),]))[20])[10]
      }
    ...
    if (p.cov.corr.sa[r] > 0.05) {
      ...
      for(i in 1:dim(allcomb)[2]){
        pt.cov.sa[r,i] <- unlist(summary(lme(pasteregions ~ 1 + gc, random = ~ 1 | suc, data = data.lmer.sa.cov[data.lmer.sa.cov$rc == r & (data.lmer.sa.cov$gc == labels.g[allcomb[1,i]] | data.lmer.sa.cov$gc == labels.g[allcomb[2,i]]),]))[20])[10]
      }
...
# Model without covariates
  kable(rbind(c("region", "No cov", "With cov"), cbind(substring(names(data.hyp[,67:(67+nr-1)]), 4), round(p.corr.sa, 3), round(p.cov.corr.sa, 3))))
