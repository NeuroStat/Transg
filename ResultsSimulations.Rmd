...
```{r Simulations code}
  ...
  for(i in 1:length(rho)){
    ...
    for(k in 1:asim){
        # Scenario 1: two groups with equal amount of subjects, 
        # groups differ with an effect size delta
        ...
        # Scenario 2: two groups with equal amount of subjects,
        # 
          # Construct a vector that determines in which group each subject falls
        ...
        # Scenario 3: two groups with equal amount of subjects,
        # 
          # Construct a vector that determines in which group each subject falls
          ...
          # What if we work with the average?
          y3m<-(y3+y3.2)/2
          # Boolean of whether an effect is detected, this is later used to compute the power
